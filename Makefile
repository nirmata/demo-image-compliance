...
publish-policies:
	...
	docker build -t $(REGISTRY)/nirmata/demo-image-compliance-policies:block-critical-vulnerabilites -f ./policies/Dockerfile --build-arg POLICY_EXPRESSION=critical.yaml ./policies
	docker build -t $(REGISTRY)/nirmata/demo-image-compliance-policies:block-high-and-critical-vulnerabilites -f ./policies/Dockerfile --build-arg POLICY_EXPRESSION=high.yaml ./policies
	docker push $(REGISTRY)/nirmata/demo-image-compliance-policies:block-critical-vulnerabilites
	docker push $(REGISTRY)/nirmata/demo-image-compliance-policies:block-high-and-critical-vulnerabilites
